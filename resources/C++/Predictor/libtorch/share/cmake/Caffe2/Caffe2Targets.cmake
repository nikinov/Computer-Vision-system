...
set_target_properties(torch_cuda PROPERTIES
  INTERFACE_LINK_LIBRARIES "torch_cuda_cu_library;torch_cuda_cpp_library"
)
...
set_target_properties(torch_cuda_cu PROPERTIES
  INTERFACE_COMPILE_OPTIONS "\$<\$<OR:\$<CONFIG:Debug>,\$<CONFIG:RelWithDebInfo>>:/Z7>;/EHsc;/DNOMINMAX;/wd4267;/wd4251;/wd4522;/wd4522;/wd4838;/wd4305;/wd4244;/wd4190;/wd4101;/wd4996;/wd4275;/bigobj"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "-INCLUDE:?searchsorted_cuda@native@at@@YA?AVTensor@2@AEBV32@0_N1@Z;torch::cudart;c10_cuda;torch::nvtoolsext;torch_cpu_library;caffe2::cufft;caffe2::curand;caffe2::cublas;caffe2::cudnn"
)
