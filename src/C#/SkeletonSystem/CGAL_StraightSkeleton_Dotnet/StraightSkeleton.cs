...
namespace CGAL_StraightSkeleton_Dotnet
{
        ...
        : IDisposable
    {
        ...
        private const string dllName = @"C:\WisonCoppies\Wision-trunk\CSharpSource\Calculation\SkeletonSystem\CGAL_StraightSkeleton_Dotnet\Debug\CGAL_StraightSkeleton_Wrapper.dll";
