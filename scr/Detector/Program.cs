...
namespace Detector
{
    ...
    {        
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(ModelMaker.Predictor.GetPrediction("C:/Users/Ryzen7 - EXT/Documents/Github/WickonHightech/scr/ModelMaker/model.pt", ImageToByteArray(im), 300, 300));
